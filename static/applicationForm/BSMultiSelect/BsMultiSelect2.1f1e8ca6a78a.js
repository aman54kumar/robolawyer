...
(function (global, factory) {
      ...
      return this.each(function (i, e) {
        ...
        if (isMethodName) {
          ...
          if (typeof instance[methodName] === "undefined") {
            ...
            if (
              methodNames.indexOf(lMethodName) < 0 ||
              typeof instance[lMethodName] === "undefined"
            ) {
    ...
    return {
      ...
      restore: function restore() {
        list.forEach(function (e) {
          ...
          if (attributeName) element.setAttribute(attributeName, attribute);
      ...
      onInput(
        ...
        function () {
          filterInputElement.style.width =
            filterInputValue.length * 1.3 + 2 + "ch";
    ...
    if (sources)
      sources.forEach(function (s) {
        for (var _property in s) {
          var _v = s[_property];
          if (!(_v === null || _v === undefined)) destination[_property] = _v;
  ...
  function composeSync() {
    for (
      var _len2 = arguments.length, functions = new Array(_len2), _key2 = 0;
      _key2 < _len2;
      _key2++
    ) {
  ...
  function sync() {
    for (
      var _len3 = arguments.length, functions = new Array(_len3), _key3 = 0;
      _key3 < _len3;
      _key3++
    ) {
  ...
  function def() {
    for (
      var _len4 = arguments.length, functions = new Array(_len4), _key4 = 0;
      _key4 < _len4;
      _key4++
    ) {
  ...
  function defCall() {
    for (
      var _len5 = arguments.length, functions = new Array(_len5), _key5 = 0;
      _key5 < _len5;
      _key5++
    ) {
    ...
    for (
      var _i2 = 0, _functions2 = functions;
      _i2 < _functions2.length;
      _i2++
    ) {
  ...
  function Choices(listFacade, _navigate, addFilterFacade, insertFilterFacade) {
    ...
    var collection = CollectionFacade(
      function (choice) {
  ...
  function MultiSelectInputAspect(
    ...
    var documentMouseup = function documentMouseup(event) {
      ...
      if (choicesElement == event.target)
        filterInputElement.focus(); // if click outside container - close dropdown
      else if (
        !containsAndSelf(choicesElement, event.target) &&
        !containsAndSelf(picksElement, event.target)
      ) {
        hideChoices();
        resetFilter();
        resetFocus();
    ...
    return {
      ...
      disable: function disable(isComponentDisabled) {
        if (isComponentDisabled) componentDisabledEventBinder.unbind();
        else
  ...
  var MultiSelect2 = /*#__PURE__*/ (function () {
    ...
    _proto.updateOptionsDisabled = function updateOptionsDisabled() {
      this.choices.forLoop(function (choice) {
        var newIsDisabled = multiSelect.dataSourceAspect.getDisabled(
          choice.option
        );
    ...
    _proto.createPick = function createPick(choice) {
      ...
      var pick = {
        disableRemove: function disableRemove() {
          return pickContent.disableRemove(
            _this3.componentAspect.getDisabled()
          );
        },
        ...
        disable: function disable() {
          return pickContent.disable(
            _this3.dataSourceAspect.getDisabled(choice.option)
          );
        },
        remove: null,
        dispose: function dispose() {
      ...
      choice.updateDisabled = composeSync(
    ...
    _proto.createChoiceElement = function createChoiceElement(choice) {
      ...
      var choiceContent = this.choiceContentGenerator(
        choiceElement,
        function () {
      ...
      choice.updateSelected = function () {
        ...
        if (choice.isOptionSelected) pickTools.updateSelectedTrue();
        else {
          pickTools.updateSelectedFalse();
          pickTools.updateSelectedFalse = null;
        }
      ...
      var unbindChoiceElement = this.aspect.adoptChoiceElement(
        choice,
        choiceElement
      );
    ...
    _proto.insertChoiceItem = function insertChoiceItem(choice) {
      ...
      choice.choiceElementAttach(
        nextChoice == null ? void 0 : nextChoice.choiceElement
      );
    };
    ...
    _proto.init = function init() {
      ...
      this.picksDom.pickFilterElement.appendChild(
        this.picksDom.filterInputElement
      );
    ...
    return {
      afterConstructor: function afterConstructor(multiSelect) {
        for (var _i = 0; _i < instances.length; _i++) {
          ...
          var dispose =
            (_instances$_i$afterCo = (_instances$_i = instances[_i])
              .afterConstructor) == null
              ? void 0
              : _instances$_i$afterCo.call(_instances$_i, multiSelect);
      ...
      dispose: function dispose() {
        ...
        for (var _i3 = 0; _i3 < instances.length; _i3++) {
          ...
          (_instances$_i3$dispos = (_instances$_i2 = instances[_i3]).dispose) ==
          null
            ? void 0
            : _instances$_i3$dispos.call(_instances$_i2);
        }
  ...
  function initiateDefaults(constructors, defaults) {
    for (var i = 0; i < constructors.length; i++) {
      ...
      (_constructors$i$setDe = (_constructors$i = constructors[i])
        .setDefaults) == null
        ? void 0
        : _constructors$i$setDe.call(_constructors$i, defaults);
    }
  }
  function mergeDefaults(constructors, configuration, defaults, settings) {
    for (var i = 0; i < constructors.length; i++) {
      ...
      (_constructors$i$merge = (_constructors$i2 = constructors[i])
        .mergeDefaults) == null
        ? void 0
        : _constructors$i$merge.call(
            _constructors$i2,
            configuration,
            defaults,
            settings
  ...
  function onConfiguration(constructors, configuration) {
    for (var i = 0; i < constructors.length; i++) {
      ...
      (_constructors$i$onCon = (_constructors$i3 = constructors[i])
        .onConfiguration) == null
        ? void 0
        : _constructors$i$onCon.call(_constructors$i3, configuration);
    }
  }
  function staticDomDefaults(constructors, staticDomFactory) {
    for (var i = 0; i < constructors.length; i++) {
      ...
      (_constructors$i$stati = (_constructors$i4 = constructors[i])
        .staticDomDefaults) == null
        ? void 0
        : _constructors$i$stati.call(_constructors$i4, staticDomFactory);
    }
  }
  ...
  function pickContentGenerator(pickElement, common, css) {
    pickElement.innerHTML =
      '<span></span><button aria-label="Remove" tabIndex="-1" type="button"><span aria-hidden="true">&times;</span></button>';
  ...
  function choiceContentGenerator(choiceElement, common, css, toggle) {
    ...
    var disable1ToggleStyling = toggleStyling(
      choiceElement,
      css.choice_disabled
    );
    var hoverInToggleStyling = toggleStyling(choiceElement, css.choice_hover);
    var disable2ToggleStyling = toggleStyling(
      choiceCheckBoxElement,
      css.choiceCheckBox_disabled
    );
    var disable3ToggleStyling = toggleStyling(
      choiceLabelElement,
  ...
  function DataSourceAspect(options, getSelected, setSelected, getDisabled) {
    ...
    if (!getDisabled)
      getDisabled = function getDisabled(option) {
  ...
  function BsMultiSelect2(element, environment, configuration, onInit) {
    ...
    if (typeof Popper === "undefined") {
      throw new Error(
        "BsMultiSelect: Popper.js (https://popper.js.org) is required"
      );
    }
    ...
    if (!common) common = {};
    var dataSourceAspect = DataSourceAspect(
      options,
      getSelected,
      setSelected,
      getIsOptionDisabled
    ...
    var _staticDomFactory$sta = staticDomFactory.staticDomGenerator(
        element,
        containerClass
      ),
    ...
    var picksDom = PicksDom(
      staticDom.picksElement,
      staticDom.disposablePicksElement,
      createElement,
      css
    );
    var popupAspect = PopupAspect$1(
      choicesDom.choicesElement,
    ...
    var pickContentGenerator$1 = def(
      configuration.pickContentGenerator,
      pickContentGenerator
    );
    var choiceContentGenerator$1 = def(
      configuration.choiceContentGenerator,
      choiceContentGenerator
    );
  ...
  function LabelPlugin(pluginData) {
    ...
    if (selectElement)
      createInputId = function createInputId() {
        return (
          containerClass +
          "-generated-input-" +
          (selectElement.id
  ...
  function ValidationApiPlugin(pluginData) {
    ...
    if (!isBoolean(required))
      required =
        selectElementPluginData == null
          ? void 0
          : selectElementPluginData.required;
    else if (!isBoolean(required)) required = false;
    valueMissingMessage = defCall(
      valueMissingMessage,
      function () {
  ...
  function BsAppearancePlugin(pluginData) {
    ...
    return {
      afterConstructor: function afterConstructor(multiSelect) {
        ...
        var validationApiObservable =
          validationApiPluginData == null
            ? void 0
            : validationApiPluginData.validationApiObservable;
        var validationObservable = ObservableLambda(function () {
          return wasUpdatedObservable.getValue()
            ? validationApiObservable.getValue()
  ...
  function composeGetSize(selectElement) {
    ...
    if (inputGroupElement) {
      ...
      getSize = function getSize() {
        var value = null;
        if (
          selectElement.classList.contains("custom-select-lg") ||
          selectElement.classList.contains("form-control-lg")
        )
          value = "lg";
        else if (
          selectElement.classList.contains("custom-select-sm") ||
          selectElement.classList.contains("form-control-sm")
        )
          value = "sm";
        return value;
      };
  ...
  function HiddenOptionPlugin(pluginData) {
    ...
    if (options) {
      if (!getIsOptionHidden)
        getIsOptionHidden = function getIsOptionHidden(option) {
    ...
    return {
      afterConstructor: function afterConstructor(multiSelect) {
        ...
        var origInsertChoiceItem =
          multiSelect.insertChoiceItem.bind(multiSelect);
        ...
        var origInsertFilterFacade =
          multiSelect.insertFilterFacade.bind(multiSelect);
    ...
    return {
      afterConstructor: function afterConstructor(multiSelect) {
        ...
        var origProcessEmptyInput =
          multiSelect.processEmptyInput.bind(multiSelect);
        multiSelect.processEmptyInput = composeSync(
          updateEmptyInputWidth,
        ...
        var origForceResetFilter =
          multiSelect.forceResetFilter.bind(multiSelect);
        multiSelect.forceResetFilter = composeSync(
          origForceResetFilter,
    ...
    return {
      afterConstructor: function afterConstructor(multiSelect) {
        ...
        multiSelect.UpdateOptionSelected = function (key) {
          ...
          var newIsSelected = multiSelect.dataSourceAspect.getSelected(
            choice.option
          );
  ...
  function SelectElementPlugin(pluginData) {
    ...
    if (selectElement) {
      ...
      if (!getIsOptionDisabled)
        dataSourceAspect.getDisabled = function (option) {
      ...
      staticManager.appendToContainer = composeSync(
        staticManager.appendToContainer,
        staticDom.attachContainerElement
      );
      staticManager.dispose = composeSync(
        staticDom.detachContainerElement,
        staticManager.dispose
      );
    }
  }
  ...
  (function (window, $, Popper) {
    ...
    var createBsMultiSelect = function createBsMultiSelect(
      element,
      settings,
      removeInstanceData
    ) {
      ...
      if (settings instanceof Function) {
        ...
        buildConfiguration =
          (_settings = settings) == null
            ? void 0
            : _settings.buildConfiguration;
      }

      if (settings) adjustLegacySettings(settings);
      configuration.css = createCss(
        defaults.css,
        (_settings2 = settings) == null ? void 0 : _settings2.css
      );
      ...
      var onInit =
        buildConfiguration == null
          ? void 0
          : buildConfiguration(element, configuration);
      onConfiguration(defaultPlugins, configuration);
      var multiSelect = BsMultiSelect2(
        element,
        environment,
        configuration,
        onInit
...
//# sourceMappingURL=BsMultiSelect2.js.8a7c54ff79f0.map
